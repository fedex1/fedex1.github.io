...
for(let x of formage){console.log(`<option value="${x}">${x}</option>`)}
console.log(`</select>`)
console.log(`</label>`)
...
for(let x of formweight){console.log(`<option value="${x}">${x}</option>`)}
console.log(`</select>`)
console.log(`</label>`)
...
for(let x of formheight_feet){console.log(`<option value="${x}">${x}</option>`)}
console.log(`</select>`)
...
for(let x of formheight_inches){console.log(`<option value="${x}">${x}</option>`)}
console.log(`</select>`)
console.log(`</label>`)
...
return {score:score,successrate: successrate}
}
